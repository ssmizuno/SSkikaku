...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
		//背景フレームの作成
		UIImage *backGroundImage = [UIImage imageNamed:@"Base01.png"];
        ...
        //概要テキスト01
		UITextView *textView01 = [[UITextView alloc] initWithFrame:CGRectMake(387, 90, 326, 350)];
		NSString *textPath01 = [[NSBundle mainBundle] pathForResource:@"PublishText02" ofType:@"txt"];
		...
		for (int i = 0; i < 6; i++) {
			...
			UIImage *scrollImage;
			if(i < 5){
				scrollImage = [UIImage imageNamed:[NSString stringWithFormat:@"0%02d.png", i+1]];
			}else {
				scrollImage = [UIImage imageNamed:[NSString stringWithFormat:@"0%02d.png", i+1]];
